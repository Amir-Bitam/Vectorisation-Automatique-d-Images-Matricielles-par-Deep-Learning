...
class VAEXperiment(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx = 0):
        ...
        if self.logger is not None:
            ...
            if hasattr(logger_experiment, 'log'):
                logger_experiment.log({'loss': train_loss['loss']})
            elif hasattr(logger_experiment, 'add_scalar'):
                logger_experiment.add_scalar('loss', train_loss['loss'], self.global_step)
        max_paths = 25
    ...
    def train_dataloader(self):
        ...
        num_workers = int(self.params.get('num_workers', 0 if os.name == 'nt' else 1))
